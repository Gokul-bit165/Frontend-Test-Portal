                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50 border-b">
                      <tr>
                        ...
                        <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Challenge</th>
                    ...
                    <tbody className="divide-y">
                      {filteredSubmissions.map(sub => (
                        <tr key={sub.id} className="hover:bg-gray-50">
                          <td className="px-6 py-4 text-sm font-mono">{sub.id.substring(0, 8)}...</td>
                          <td className="px-6 py-4 text-sm font-semibold">{sub.candidateName}</td>
                          <td className="px-6 py-4 text-sm">{sub.challengeId}</td>
                          ...
                          <td className="px-6 py-4 text-sm">{sub.result?.finalScore || 0}%</td>
